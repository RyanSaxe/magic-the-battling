...
export function DraftPhase({ gameState, actions }: DraftPhaseProps) {
  ...
  const handleCardClick = useCallback((card: CardType, index: number, zone: SelectionZone, isInHand: boolean) => {
      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-0">
        {currentPack.length === 0 ? (
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm">Wait for the next pack or click "Done Drafting"</p>
          </div>
        ) : (
          <>
